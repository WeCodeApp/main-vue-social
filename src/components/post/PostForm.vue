  ...
  <Card class="post-form" :flat="!isEditing">
    ...
    <div class="form-content">
      <div class="form-user" v-if="!isEditing">
        ...
        />
        <div class="user-info">
          <div class="user-name">{{ userStore.user?.displayName }}</div>
          <div class="privacy-selector">
            <select v-model="privacy" class="privacy-select">
              <option value="public">
                <span class="mdi mdi-earth"></span> Public
              </option>
              <option value="private">
                <span class="mdi mdi-lock"></span> Friends Only
              </option>
              <option v-if="groupId" value="group">
                <span class="mdi mdi-account-group"></span> Group
              </option>
            </select>
          </div>
        </div>
      ...
      <div class="form-group">
        <textarea 
          v-model="content" 
          class="form-textarea" 
          :placeholder="isEditing ? 'Edit your post...' : 'What\'s on your mind?'"
          rows="3"
          @input="autoResize"
          ref="textareaRef"
        ></textarea>
...
// Form state
const content = ref('')
const privacy = ref<'public' | 'private' | 'group'>(props.groupId ? 'group' : 'public')
