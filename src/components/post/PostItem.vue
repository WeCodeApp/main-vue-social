    ...
    <template #header>
      <div class="post-header">
        ...
        <div class="post-actions">
          <div v-if="post.visibility !== 'public'" class="post-privacy">
            <span 
              class="mdi" 
              :class="post.visibility === 'private' ? 'mdi-lock' : 'mdi-account-group'"
              :title="post.visibility === 'private' ? 'Private post' : 'Group post'"
            ></span>
          </div>
